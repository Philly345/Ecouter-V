          ...
          <div className="bg-black border-b border-white/10 px-6 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-xl font-semibold">Edit Transcript</h1>
                  <p className="text-white/60 text-sm">{file.originalName}</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-green-600 hover:bg-green-700 disabled:bg-green-600/50 rounded-lg text-sm flex items-center space-x-2"
                >
