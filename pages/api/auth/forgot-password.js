...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log('- SMTP_SERVER:', process.env.SMTP_SERVER ? 'Set ✅' : 'Missing ❌');
    ...
    // Setup email transporter with working Brevo SMTP
    ...
    // Create reset URL - use production domain
    const baseUrl = process.env.BASE_URL || process.env.NEXTAUTH_URL || 'https://ecoutertranscribe.tech';
    const resetUrl = `${baseUrl}/reset-password?token=${resetToken}`;
    
    console.log('🔗 Reset URL generated:', resetUrl);
    
    // Professional email template for better delivery
    const mailOptions = {
