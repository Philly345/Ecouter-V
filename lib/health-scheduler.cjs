...
class HealthScheduler {
  constructor() {
    ...
    this.scheduledTimes = [
      ...
      { hour: 1, minute: 35, name: '1:35 AM' },   // Early morning check
      { hour: 1, minute: 45, name: '1:45 AM' },   // Early morning check 2
      { hour: 1, minute: 55, name: '1:55 AM' },   // Early morning check 3
      { hour: 2, minute: 10, name: '2:10 AM' },   // Early morning check 4
