...
class AdvancedHealthScheduler {
  constructor() {
    ...
    // Enhanced scheduling - 12 times per day with optimized timing
    this.scheduledTimes = [
      { hour: 0, minute: 0 },   // 12:00 AM
      { hour: 0, minute: 50 },  // 12:50 AM
      { hour: 1, minute: 35 },  // 1:35 AM
      { hour: 1, minute: 45 },  // 1:45 AM
      { hour: 1, minute: 55 },  // 1:55 AM
      { hour: 2, minute: 10 },  // 2:10 AM
      { hour: 2, minute: 40 },  // 2:40 AM
